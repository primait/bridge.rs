...
## [0.31.2](https://github.com/primait/bridge.rs/compare/v0.31.1...v0.31.2) - 2026-09-09

### Other

- *(deps-cargo)* bump the cargo-non-major group across 1 directory with 4 updates ([#305](https://github.com/primait/bridge.rs/pull/305))
